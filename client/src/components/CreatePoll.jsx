...
class CreatePoll extends Component {
  ...
  addAnswer() {
    this.setState({ options: [...this.state.options, ''] });    //appending a new option
  }

  removeAnswer() {
    var n = this.state.options.length-1;
    (n>1 && this.setState({ options: this.state.options.splice(0,n) }));    //removing last option
  }
